...
export class CPU {
    ...
    */
    ...
    //I really hope that this does not have to stay.
    getNextControl(){
         // ====================
        // FETCH
        // ====================
        ...
        // Update dmem
        this.dMem.setWriteEnable(0); //writeEnable low so that processor state does not change, faux cycle
        this.dMem.setRegister(dmemAddr, this.dmemInputMux.getOutput());     
        ...
        // Update registers
        this.registers.setWriteEnable(0); //writeEnable low so that processor state does not change, faux cycle
        let targetRegister = parseInt(this.control.get('c8c9'), 2);
        this.registers.setRegister(targetRegister, writebackResult);
