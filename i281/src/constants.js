...
export const REGISTER_FILE_OFFSET = [600, 400];
...
export const SWITCHES_MUX1_WIRE = ["M", MUX2_OFFSET[0] - 200, MUX2_OFFSET[1] + MUX_TRUE[1] - 15, "l", 200, 0] ;
    ...
    export const TO_OPCODE_DECODER = ["M", CODE_MEM_OFFSET[0] + CODE_MEM_WIDTH + 35, CODE_MEM_OFFSET[1]+25, "l", 0,0, 315,0]
    ...
    export const TO_MUX0 = ["M", CODE_MEM_OFFSET[0]+CODE_MEM_WIDTH+15+700,125+825, "l", 0,-165, 85,0 ]
    export const TO_MUX1 = ["M", CODE_MEM_OFFSET[0]+CODE_MEM_WIDTH+15+700,125+825, "l", 375,0, 0,-215, 60,0]

    export const TO_PC_UPDATE = ["M", CODE_MEM_OFFSET[0]+CODE_MEM_WIDTH+35,125+825, "l", 0,250, 15,0]
    //END IMEM segments
    ...
    //READ_A SEGMENTS
    export const READ_A_OUT = ["M", REGISTER_FILE_OFFSET[0]+REGISTER_FILE_WIDTH, REGISTER_FILE_OFFSET[1]+150, "l", 25,0, 375,0]
    //END READ_A_SEGMENTS

    //READ_B_SEGMENTS
    export const READ_B_OUT = ["M", REGISTER_FILE_OFFSET[0]+REGISTER_FILE_WIDTH, REGISTER_FILE_OFFSET[1]+400, "l", 25,0]
    export const B_OUT_TO_MUX0 = ["M", REGISTER_FILE_OFFSET[0]+REGISTER_FILE_WIDTH+25, REGISTER_FILE_OFFSET[1]+400, "l", 0,-100, 275,0]
    export const B_OUT_TO_MUX2 = ["M", REGISTER_FILE_OFFSET[0]+REGISTER_FILE_WIDTH+25, REGISTER_FILE_OFFSET[1]+400, "l", 0,200, 625,0]
    //END READ_B SEGMENTS

    //MUX1 DMEM SEGMENTS
    export const MUX1_OUT = ["M", 1675,700, "l", 25,0]
    export const MUX1_OUT_TO_MUX3 = ["M", 1675+25,700, "l", 550,0]
