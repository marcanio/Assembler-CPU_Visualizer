...
//[0,0, 125,50, 125,250, 0,300, 0,200, 50, 175, 50,125, 0,100 ];
...
export const CODE_MEM_OFFSET = [70, 100];
var change = 30;
...
export const PC_UPDATE_OFFSET = [550, 1150];
export const DATA_MEM_OFFSET = [1750, 900];

export const INTERSECT_1_POS = [CODE_MEM_OFFSET[0] + CODE_MEM_WIDTH + 35, CODE_MEM_OFFSET[1] + 25];
export const INTERSECT_2_POS = [CODE_MEM_OFFSET[0] + CODE_MEM_WIDTH + 35, CODE_MEM_OFFSET[1] + (PC_UPDATE_OFFSET[1] - CODE_MEM_OFFSET[1] - 200)];
export const INTERSECT_3_POS = [CODE_MEM_OFFSET[0] + CODE_MEM_WIDTH + 35, CODE_MEM_OFFSET[1] + 25 + PC_UPDATE_OFFSET[1] + 150];
export const INTERSECT_4_POS = [MUX0_OFFSET[0] - 65 , CODE_MEM_OFFSET[1] + (PC_UPDATE_OFFSET[1] - CODE_MEM_OFFSET[1] - 200)];
export const INTERSECT_5_POS = [MUX1_OFFSET[0] + MUX_POLYGON[2]+ 480, MUX1_OFFSET[1] + 100];
export const INTERSECT_6_POS = [REGISTER_FILE_OFFSET[0] + REGISTER_FILE_WIDTH + 25, REGISTER_FILE_OFFSET[1] + 378];
export const INTERSECT_7_POS = [MUX1_OFFSET[0] + MUX_POLYGON[2] + 30, MUX1_OFFSET[1] + 100];
export const INTERSECT_8_POS = [MUX1_OFFSET[0] + MUX_POLYGON[2] + 30, MUX1_OFFSET[1] + 100 + ((DATA_MEM_OFFSET[1] - MUX1_OFFSET[1]) - 65) ];
...
export const FLAGS_CONTROL_WIRE = ["M", FLAGS_OFFSET[0] + FLAGS_POLYGON[2], FLAGS_OFFSET[1] + FLAGS_POLYGON[2]/2, "l", 25,0, 0,-150 ,-600, 0, 0, -220, 125, 0 ];
...
export const MUX_REG_FILE_WIRE = ["M", MUX3_OFFSET[0] + MUX_POLYGON[2], MUX3_OFFSET[1] + 100, "l", 25,0, 0,-(MUX3_OFFSET[1] - REGISTER_FILE_OFFSET[1] + 190), -(MUX3_OFFSET[0] - REGISTER_FILE_OFFSET[0] + 50 + MUX_WIDTH), 0, 0, 200, 25, 0 ];
...
export const IMEM_PC_VAL_MUX_WIRE = ["M", CODE_MEM_OFFSET[0], CODE_MEM_OFFSET[1] + 300, "l", -25, 0, 0, (PC_UPDATE_OFFSET[1] - CODE_MEM_OFFSET[1]) , (PC_VALUE_OFFSET[0] + CODE_MEM_OFFSET[0] + 50)+change+30, 0, 0, -220, -25, 0];
...
export const SWITCHES_MUX1_WIRE = ["M", MUX2_OFFSET[0] - 200, MUX2_OFFSET[1] + MUX_TRUE[1] - 15, "l", 200, 0] ;
    ...
    //IMEM segments
    export const CODE_MEM_OUT_0 = ["M", CODE_MEM_OFFSET[0] + CODE_MEM_WIDTH, CODE_MEM_OFFSET[1]+25, "l", 0,0,35,0]
    export const TO_OPCODE_DECODER = ["M", CODE_MEM_OFFSET[0] + CODE_MEM_WIDTH + 35, CODE_MEM_OFFSET[1]+25, "l", 0,0, 315+change,0]
    export const PC_MUX_JUNCTION = ["M", CODE_MEM_OFFSET[0] + CODE_MEM_WIDTH + 35, CODE_MEM_OFFSET[1]+25, "l", 0,825]

    export const MUX_JUNCTION = ["M", CODE_MEM_OFFSET[0]+CODE_MEM_WIDTH+35,125+825, "l", 681,0]

    export const TO_MUX0 = ["M", CODE_MEM_OFFSET[0]+CODE_MEM_WIDTH+15+650,125+825, "l", 0,-120, 65,0 ]
    export const TO_MUX1 = ["M", CODE_MEM_OFFSET[0]+CODE_MEM_WIDTH+15+700,125+825, "l", 375,0, 0,-220, 40,0]

    export const TO_PC_UPDATE = ["M", CODE_MEM_OFFSET[0]+CODE_MEM_WIDTH+35,125+825, "l", 0,250, 15+change,0]
    //END IMEM segments

    //IMEM MUX2 SEGMENTS
    export const IMEM_MUX2_JUNCTION = ["M", CODE_MEM_OFFSET[0], CODE_MEM_OFFSET[1] + 200, "l", -50,0, 0,1200, (MUX2_OFFSET[0]- CODE_MEM_OFFSET[0] - 100),0, 0,-425]
    //END IMEM MUX2 SEGMENTS

    //READ_A SEGMENTS
    export const READ_A_OUT = ["M", REGISTER_FILE_OFFSET[0]+REGISTER_FILE_WIDTH-18, REGISTER_FILE_OFFSET[1]+125, "l", 25,0, 375+18,0]
    //END READ_A_SEGMENTS

    //READ_B_SEGMENTS
    export const READ_B_OUT = ["M", REGISTER_FILE_OFFSET[0]+REGISTER_FILE_WIDTH-18, REGISTER_FILE_OFFSET[1]+380, "l", 25+18,0]
    export const B_OUT_TO_MUX0 = ["M", REGISTER_FILE_OFFSET[0]+REGISTER_FILE_WIDTH+25, REGISTER_FILE_OFFSET[1]+380, "l", 0,-65, 225,0]
    export const B_OUT_TO_MUX2 = ["M", REGISTER_FILE_OFFSET[0]+REGISTER_FILE_WIDTH+25, REGISTER_FILE_OFFSET[1]+380, "l", 0,200, 625,0]
    //END READ_B SEGMENTS

    //MUX1 DMEM SEGMENTS
    export const MUX1_OUT = ["M", 1675,700, "l", 25,0]
    export const MUX1_OUT_TO_MUX3_IMEM_JUNCTION = ["M", 1675+25,700, "l", 450,0]
    export const MUX1_OUT_TO_DMEM_JUNCTION = ["M", 1675+25,700, "l", 0,235]
    export const JUNCTION_TO_DMEM_A = ["M", 1675+25, 700+235, "l", 50,0]
    export const JUNCTION_TO_DMEM_B = ["M", 1675+25, 700+235, "l", 0,40, 50,0]
    export const JUNCTION_TO_IMEM = ["M", 1675+25+450, 700, "l", 0,-681, -2145,0, 0,150, 50,0]
    export const JUNCTION_TO_MUX3 = ["M", 1675+25+450, 700, "l", 100,0]
...
export const MUX_PC_VAL_WIRE = ["M", 870,1235, "l", 130,0];
