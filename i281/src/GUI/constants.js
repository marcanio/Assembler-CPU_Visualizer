...
export const FLAGS_CONTROL_WIRE = ["M", FLAGS_OFFSET[0] + FLAGS_POLYGON[2], FLAGS_OFFSET[1] + FLAGS_HIEGHT/2, "l", 25,0, 0,-120 ,-500, 0, 0, -200, 25, 0 ];
...
export const MUX2_DMEM_WIRE = ["M", MUX2_OFFSET[0] + MUX_POLYGON[2], MUX2_OFFSET[1] + 80, "l", (DATA_MEM_OFFSET[0] - MUX2_OFFSET[0] - MUX_WIDTH), 0];
...
export const SWITCHES_MUX1_WIRE = ["M", MUX2_OFFSET[0] - 200, MUX2_OFFSET[1] + MUX_TRUE[1] - 15, "l", 200, 0] ;
    ...
    export const MUX_JUNCTION = ["M", INTERSECT_1_POS[0],125+825, "l", 681,0]
    ...
    export const TO_PC_UPDATE = ["M", INTERSECT_1_POS[0],125+825, "l", 0,250, 60,0]
    //END IMEM segments

    //IMEM MUX2 SEGMENTS
    export const IMEM_MUX2_JUNCTION = ["M", CODE_MEM_OFFSET[0], CODE_MEM_OFFSET[1] + 200, "l", -50,0, 0,1200, (MUX2_OFFSET[0]- CODE_MEM_OFFSET[0] - 100),0, 0,-370]
    //END IMEM MUX2 SEGMENTS

    //READ_A SEGMENTS
    export const READ_A_OUT = ["M", REGISTER_FILE_OFFSET[0]+REGISTER_FILE_WIDTH - 22, REGISTER_FILE_OFFSET[1]+125, "l", 390,0]
    //END READ_A_SEGMENTS

    //READ_B_SEGMENTS
    export const READ_B_OUT = ["M", REGISTER_FILE_OFFSET[0]+REGISTER_FILE_WIDTH-22, REGISTER_FILE_OFFSET[1]+380, "l", 25+22,0]
    export const B_OUT_TO_MUX0 = ["M", REGISTER_FILE_OFFSET[0]+REGISTER_FILE_WIDTH+25, REGISTER_FILE_OFFSET[1]+380, "l", 0,-65, 195,0]
    export const B_OUT_TO_MUX2 = ["M", REGISTER_FILE_OFFSET[0]+REGISTER_FILE_WIDTH+25, REGISTER_FILE_OFFSET[1]+380, "l", 0,270, 595,0]
    //END READ_B SEGMENTS
