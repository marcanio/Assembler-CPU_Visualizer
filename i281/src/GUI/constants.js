...
export const REGISTER_FILE_OFFSET = [600, 405];
...
export const INTERSECT_2_POS = [CODE_MEM_OFFSET[0] + CODE_MEM_WIDTH + 60, CODE_MEM_OFFSET[1] + (PC_UPDATE_OFFSET[1] - CODE_MEM_OFFSET[1] - 200)];
export const INTERSECT_3_POS = [CODE_MEM_OFFSET[0] + CODE_MEM_WIDTH + 60, CODE_MEM_OFFSET[1] + 25 + PC_UPDATE_OFFSET[1] + 172];
export const INTERSECT_4_POS = [MUX0_OFFSET[0] - 45 , CODE_MEM_OFFSET[1] + (PC_UPDATE_OFFSET[1] - CODE_MEM_OFFSET[1] - 200)];
export const INTERSECT_5_POS = [MUX1_OFFSET[0] + MUX_POLYGON[2]+ 480, MUX1_OFFSET[1] + 86];
export const INTERSECT_6_POS = [REGISTER_FILE_OFFSET[0] + REGISTER_FILE_WIDTH + 25, REGISTER_FILE_OFFSET[1] + 400];
export const INTERSECT_7_POS = [MUX1_OFFSET[0] + MUX_POLYGON[2] + 60, MUX1_OFFSET[1] + 87];
export const INTERSECT_8_POS = [MUX1_OFFSET[0] + MUX_POLYGON[2] + 60, MUX1_OFFSET[1] + 100 + ((DATA_MEM_OFFSET[1] - MUX1_OFFSET[1]) - 15) ];
export const INTERSECT_9_POS = [ MUX2_OFFSET[0] - 165, MUX2_OFFSET[1] + MUX_TRUE[1] - 10];
...
export const SWITCHES_MUX1_WIRE = ["M", MUX2_OFFSET[0] - 200, MUX2_OFFSET[1] + MUX_TRUE[1] - 10, "l", 200, 0] ;
    ...
    export const MUX_JUNCTION = ["M", INTERSECT_1_POS[0],125+825, "l", 605,0]

    export const TO_MUX0 = ["M", CODE_MEM_OFFSET[0]+CODE_MEM_WIDTH+15+650,125+825, "l", 0,-120, 45,0 ]
    export const TO_MUX1 = ["M", CODE_MEM_OFFSET[0]+CODE_MEM_WIDTH+15+650,125+825, "l", 405,0, 0,-205, 40,0]

    export const TO_PC_UPDATE = ["M", INTERSECT_1_POS[0],125+825, "l", 0,250, 50,0]
    //END IMEM segments

    //IMEM MUX2 SEGMENTS
    export const IMEM_MUX2_JUNCTION = ["M", CODE_MEM_OFFSET[0], CODE_MEM_OFFSET[1] + 200, "l", -64,0, 0,1200, (MUX2_OFFSET[0]- CODE_MEM_OFFSET[0] - 100),0, 0,-350]
    ...
    //READ_A SEGMENTS
    export const READ_A_OUT = ["M", REGISTER_FILE_OFFSET[0]+REGISTER_FILE_WIDTH-22,REGISTER_FILE_OFFSET[1]+150, "l", 393,0]
    //END READ_A_SEGMENTS

    //READ_B_SEGMENTS
    export const READ_B_OUT = ["M", REGISTER_FILE_OFFSET[0]+REGISTER_FILE_WIDTH-22, REGISTER_FILE_OFFSET[1]+400, "l", 25+22,0]
    export const B_OUT_TO_MUX0 = ["M", REGISTER_FILE_OFFSET[0]+REGISTER_FILE_WIDTH+25, REGISTER_FILE_OFFSET[1]+400, "l", 0,-65, 195,0]
    export const B_OUT_TO_MUX2 = ["M", REGISTER_FILE_OFFSET[0]+REGISTER_FILE_WIDTH+25, REGISTER_FILE_OFFSET[1]+400, "l", 0,260, 595,0]
    //END READ_B SEGMENTS
