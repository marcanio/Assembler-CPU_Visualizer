...
export default class FlagsSVG {
	constructor() {
		...
		this.flags_text =  new TextSVG(Constants.FLAG_TPOS[0],Constants.FLAG_TPOS[1], Constants.FLAG_TEXT_ID, Constants.FLAG_TEXT, Constants.TEXT_STYLE, Constants.FLAGS_OFFSET);
	...
	get_all_nodes() {
		...
		res.push(this.parity_flag.get_node());
