...
export default class DMEM_SVG {
	constructor() {
		...
		this.addr0 = new TextSVG(ADDR[0], ADDR[1] + (BETWEEN_DIST * 1), Constants.DMEM_ADDR0_ID, "0000", Constants.TEXT_STYLE, Constants.DATA_MEM_OFFSET);
		this.addr1 = new TextSVG(ADDR[0], ADDR[1] + (BETWEEN_DIST * 2), Constants.DMEM_ADDR1_ID, "0001", Constants.TEXT_STYLE, Constants.DATA_MEM_OFFSET);
		this.addr2 = new TextSVG(ADDR[0], ADDR[1] + (BETWEEN_DIST * 3), Constants.DMEM_ADDR2_ID, "0010", Constants.TEXT_STYLE, Constants.DATA_MEM_OFFSET);
		this.addr3 = new TextSVG(ADDR[0], ADDR[1] + (BETWEEN_DIST * 4), Constants.DMEM_ADDR3_ID, "0011", Constants.TEXT_STYLE, Constants.DATA_MEM_OFFSET);
		this.addr4 = new TextSVG(ADDR[0], ADDR[1] + (BETWEEN_DIST * 5), Constants.DMEM_ADDR4_ID, "0100", Constants.TEXT_STYLE, Constants.DATA_MEM_OFFSET);
		this.addr5 = new TextSVG(ADDR[0], ADDR[1] + (BETWEEN_DIST * 6), Constants.DMEM_ADDR5_ID, "0101", Constants.TEXT_STYLE, Constants.DATA_MEM_OFFSET);
		this.addr6 = new TextSVG(ADDR[0], ADDR[1] + (BETWEEN_DIST * 7), Constants.DMEM_ADDR6_ID, "0110", Constants.TEXT_STYLE, Constants.DATA_MEM_OFFSET);
		this.addr7 = new TextSVG(ADDR[0], ADDR[1] + (BETWEEN_DIST * 8), Constants.DMEM_ADDR7_ID, "0111", Constants.TEXT_STYLE, Constants.DATA_MEM_OFFSET);
		this.addr8 = new TextSVG(ADDR[0], ADDR[1] + (BETWEEN_DIST * 9), Constants.DMEM_ADDR8_ID, "1000", Constants.TEXT_STYLE, Constants.DATA_MEM_OFFSET);
		this.addr9 = new TextSVG(ADDR[0], ADDR[1] + (BETWEEN_DIST * 10), Constants.DMEM_ADDR9_ID, "1001", Constants.TEXT_STYLE, Constants.DATA_MEM_OFFSET);
		this.addr10 = new TextSVG(ADDR[0], ADDR[1] + (BETWEEN_DIST * 11), Constants.DMEM_ADDR10_ID, "1010", Constants.TEXT_STYLE, Constants.DATA_MEM_OFFSET);
		this.addr11 = new TextSVG(ADDR[0], ADDR[1] + (BETWEEN_DIST * 12), Constants.DMEM_ADDR11_ID, "1011", Constants.TEXT_STYLE, Constants.DATA_MEM_OFFSET);
		this.addr12 = new TextSVG(ADDR[0], ADDR[1] + (BETWEEN_DIST * 13), Constants.DMEM_ADDR12_ID, "1100", Constants.TEXT_STYLE, Constants.DATA_MEM_OFFSET);
		...
		this.val3_box = new PolygonSVG(Constants.DMEM_BOX3_ID, [...Constants.REGISTER_BOX], Constants.BLOCK_STYLE, [BOX_OFFSET[0], BOX_OFFSET[1] + (BETWEEN_DIST * 4)]);
		this.val4_box = new PolygonSVG(Constants.DMEM_BOX4_ID, [...Constants.REGISTER_BOX], Constants.BLOCK_STYLE, [BOX_OFFSET[0], BOX_OFFSET[1] + (BETWEEN_DIST * 5)]);
		this.val5_box = new PolygonSVG(Constants.DMEM_BOX5_ID, [...Constants.REGISTER_BOX], Constants.BLOCK_STYLE, [BOX_OFFSET[0], BOX_OFFSET[1] + (BETWEEN_DIST * 6)]);
		this.val6_box = new PolygonSVG(Constants.DMEM_BOX6_ID, [...Constants.REGISTER_BOX], Constants.BLOCK_STYLE, [BOX_OFFSET[0], BOX_OFFSET[1] + (BETWEEN_DIST * 7)]);
		this.val7_box = new PolygonSVG(Constants.DMEM_BOX7_ID, [...Constants.REGISTER_BOX], Constants.BLOCK_STYLE, [BOX_OFFSET[0], BOX_OFFSET[1] + (BETWEEN_DIST * 8)]);
		this.val8_box = new PolygonSVG(Constants.DMEM_BOX8_ID, [...Constants.REGISTER_BOX], Constants.BLOCK_STYLE, [BOX_OFFSET[0], BOX_OFFSET[1] + (BETWEEN_DIST * 9)]);
		this.val9_box = new PolygonSVG(Constants.DMEM_BOX9_ID, [...Constants.REGISTER_BOX], Constants.BLOCK_STYLE, [BOX_OFFSET[0], BOX_OFFSET[1] + (BETWEEN_DIST * 10)]);
		this.val10_box = new PolygonSVG(Constants.DMEM_BOX10_ID, [...Constants.REGISTER_BOX], Constants.BLOCK_STYLE, [BOX_OFFSET[0], BOX_OFFSET[1] + (BETWEEN_DIST * 11)]);
		this.val11_box = new PolygonSVG(Constants.DMEM_BOX11_ID, [...Constants.REGISTER_BOX], Constants.BLOCK_STYLE, [BOX_OFFSET[0], BOX_OFFSET[1] + (BETWEEN_DIST * 12)]);
		this.val12_box = new PolygonSVG(Constants.DMEM_BOX12_ID, [...Constants.REGISTER_BOX], Constants.BLOCK_STYLE, [BOX_OFFSET[0], BOX_OFFSET[1] + (BETWEEN_DIST * 13)]);
